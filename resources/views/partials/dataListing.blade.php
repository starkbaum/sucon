@foreach($data as $singleData)
    <li class="collection-item avatar">
        ...
        <p class="secondary-content">
            ...
            <a href="{{ url('mail/create', $singleData->id) }}" class="tooltipped" data-position="top" data-tooltip="Datei verschicken"><i class="material-icons sucon-text-orange">mail</i></a>
            <!-- TODO check if admin -->
